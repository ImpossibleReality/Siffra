...
<div class="editor-wrapper">
    <div class="input-wrapper">
        <div class="anchor-el">
            <div class="input-el" contenteditable="true" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" bind:this={inputEl} on:input={update_line_size} on:input={update_result}></div>
    ...
    <div class="output-container" bind:this={outputEl}>
        {#each lineData as line, i}
            <div style="height: {line.height}px" class="output-line"><span class="output" on:click={(e) => navigator.clipboard.writeText(e.target.innerText)}>{line.output}</span></div>
        {/each}
    </div>
</div>
